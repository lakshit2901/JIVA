...
from ROBOT.modules.helper_funcs.chat_status import (
    bot_admin,
    can_promote,
    user_admin,
    can_pin,
)
from ROBOT.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from ROBOT.modules.helper_funcs.admin_rights import (
    user_can_pin,
    user_can_promote,
    user_can_changeinfo,
)
...
def promote(update, context):
    ...
    if user_member.status == "administrator" or user_member.status == "creator":
        message.reply_text("This person is already an admin... GIB PARTY ANYWAY!!")
        return ""
    ...
    message.reply_text("₪Promoted Successfully....! Gib party... yayayayay yo!!!₪")
    return (
        "<b>{}:</b>"
        "\n#PROMOTED"
        "\n<b>Admin:</b> {}"
...
def demote(update, context):
    ...
    try:
        ...
        message.reply_text(
            ...
            "user, so I can't act upon them! i am so sed gonna play sad son..!"
        )
        return ""
