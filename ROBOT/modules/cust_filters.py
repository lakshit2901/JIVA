...
from ROBOT import dispatcher, LOGGER
from ROBOT.modules.disable import DisableAbleCommandHandler
from ROBOT.modules.helper_funcs.chat_status import user_admin
from ROBOT.modules.helper_funcs.extraction import extract_text
from ROBOT.modules.helper_funcs.filters import CustomFilters
from ROBOT.modules.helper_funcs.misc import build_keyboard
from ROBOT.modules.helper_funcs.string_handling import split_quotes, button_markdown_parser
from ROBOT.modules.sql import cust_filters_sql as sql
            ...
            if filt.is_sticker:
                ...
                try:
                    ...
                    if excp.message == "Unsupported url protocol":
                        message.reply_text("You seem to be trying to use an unsupported url protocol.")
