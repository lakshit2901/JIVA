...
if ENV:
    ...
    from ROBOT.config import Development as Config
...
telethn = TelegramClient("ROBOT", api_id, api_hash)
...
from ROBOT.modules.helper_funcs.handlers import CustomCommandHandler
